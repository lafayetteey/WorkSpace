...
VALUES(BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1,0, 
'첫번째 글','1번 글입니다.','유저1',SYSDATE);

--두번째 글 작성
INSERT INTO ANSWERBOARD
VALUES(BOARDNOSQ.NEXTVAL, GROUPNOSQ.NEXTVAL, 1,0, 
'두번째 글','2번 글입니다.','유저2',SYSDATE);
...
VALUES(BOARDNOSQ.NEXTVAL,
	...
	'RE:RE:두번째 글', '2번 글의 답글답글입니다.(2)','유저2',SYSDATE);		
...
VALUES(BOARDNOSQ.NEXTVAL,
	...
	'RE:RE:두번째 글', '2번 글의 답글의 답글!!.(2)','유저2',SYSDATE);	
